                    ...
                    <div className={styles.timelineBlock} id="overlayEducation">
                      ...
                      <div className={styles.timelineContent}>
                        ...
                        <p className={styles.p}>
                          ...
                          Development with React Native and Expo Go Visual
                          Studio Code, Packaging and Compiling, Git and GitHub.
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className={styles.timelineBlock}>
                      ...
                      <div className={styles.timelineContent}>
                        ...
                        <p className={styles.p}>
                          ...
                          developed, involving frontend and backend, a mobile
                          app designed for the mobile user using React-Native. A
                          backend server was built using MongoDB and Express to
                          handle fetching and storing data. A user can schedule
                          a campsite reservation, post and view comments, and
                          give a rating based on their experience at the
                          campsite.
                        </p>
                      </div>
                    </div>
